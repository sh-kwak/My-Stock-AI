...
# ============================================================================
# 백업 종목 리스트 (시총 상위 400개 보통주, 우선주/ETF/펀드 제외, 2024년 기준)
# ============================================================================
BACKUP_STOCK_LIST = [
    # 1-50: 초대형주
    ...
    ("012330", "현대모비스"), ("051910", "LG화학"), ("003670", "포스코퓨처엠"),
    ("055550", "신한지주"), ("105560", "KB금융"), ("096770", "SK이노베이션"),
    ("066570", "LG전자"), ("034730", "SK"), ("015760", "한국전력"),
    ("032830", "삼성생명"), ("003550", "LG"), ("017670", "SK텔레콤"),
    ("086790", "하나금융지주"), ("033780", "KT&G"), ("316140", "우리금융지주"),
    ("009150", "삼성전기"), ("018260", "삼성에스디에스"), ("011200", "HMM"),
    ("010130", "고려아연"), ("034020", "두산에너빌리티"), ("010950", "S-Oil"),
    ("000810", "삼성화재"), ("024110", "기업은행"), ("259960", "크래프톤"),
    ("030200", "KT"), ("036570", "엔씨소프트"), ("090430", "아모레퍼시픽"),
    ("011170", "롯데케미칼"), ("005830", "DB손해보험"), ("000720", "현대건설"),
    ("138040", "메리츠금융지주"), ("047050", "포스코인터내셔널"), ("161390", "한국타이어앤테크놀로지"),
    ("011070", "LG이노텍"), ("010140", "삼성중공업"), ("000880", "한화"),
    ("009540", "HD한국조선해양"), ("042660", "한화오션"),
    # 51-100: 대형주
    ("004020", "현대제철"), ("267250", "HD현대"), ("097950", "CJ제일제당"),
    ("003490", "대한항공"), ("352820", "하이브"), ("377300", "카카오페이"),
    ("020150", "일진머티리얼즈"), ("086280", "현대글로비스"), ("021240", "코웨이"),
    ("004990", "롯데지주"), ("088350", "한화생명"), ("326030", "SK바이오팜"),
    ("271560", "오리온"), ("034220", "LG디스플레이"), ("009830", "한화솔루션"),
    ("016360", "삼성증권"), ("000100", "유한양행"), ("180640", "한진칼"),
    ("069500", "삼성카드"), ("029780", "삼성카드"), ("004170", "신세계"), 
    ("241560", "두산밥캣"), ("000120", "CJ대한통운"), ("001450", "현대해상"),
    ("302440", "SK바이오사이언스"), ("192820", "코스맥스"), ("008770", "호텔신라"),
    ("214420", "토니모리"), ("023530", "롯데쇼핑"), ("012450", "한화에어로스페이스"),
    ("006800", "미래에셋증권"), ("053800", "안랩"), ("139480", "이마트"),
    ("071050", "한국금융지주"), ("323410", "카카오뱅크"), ("004370", "농심"),
    ("001040", "CJ"), ("251270", "넷마블"), ("282330", "BGF리테일"),
    ("000150", "두산"), ("005940", "NH투자증권"), ("022100", "포스코DX"),
    ("035250", "강원랜드"), ("064350", "현대로템"), ("272210", "한화시스템"),
    ("383220", "F&F"), ("128940", "한미약품"), ("005870", "휴니드"),
    # 101-150: 중대형주
    ("016380", "KG동부제철"), ("009420", "한올바이오파마"), ("007070", "GS리테일"),
    ("011780", "금호석유"), ("006360", "GS건설"), ("000990", "DB하이텍"),
    ("112610", "씨에스윈드"), ("078930", "GS"), ("298050", "효성첨단소재"),
    ("267260", "HD현대일렉트릭"), ("047810", "한국항공우주"), ("003410", "쌍용C&E"),
    ("001800", "오리온홀딩스"), ("267270", "HD현대건설기계"), ("003200", "일신방직"),
    ("004800", "효성"), ("036460", "한국가스공사"), ("001120", "LX인터내셔널"),
    ("088980", "맥쿼리인프라"), ("008930", "한미사이언스"), ("006280", "녹십자"),
    ("000080", "하이트진로"), ("008060", "대덕전자"), ("092780", "동양생명"),
    ("272550", "삼양패키징"), ("000070", "삼양홀딩스"), ("002790", "아모레G"),
    ("007310", "오뚜기"), ("005300", "롯데칠성"), ("014680", "한솔케미칼"),
    ("033240", "자화전자"), ("007660", "이수페타시스"), ("006260", "LS"),
    ("001740", "SK네트웍스"), ("192400", "쿠쿠홀딩스"), ("052690", "한전기술"),
    ("095720", "웅진씽크빅"), ("039490", "키움증권"), ("003240", "태광산업"),
    ("285130", "SK케미칼"), ("002380", "KCC"), ("298040", "효성중공업"),
    ("017800", "현대엘리베이터"), ("010120", "LS일렉트릭"), ("073240", "금호타이어"),
    ("003030", "세아제강지주"), ("042670", "HD현대인프라코어"), ("003920", "남양유업"),
    ("005389", "현대차"), ("003090", "대웅"),
    # 151-200: 중형주
    ("044820", "코스맥스비티아이"), ("081660", "휠라홀딩스"), ("004000", "롯데정밀화학"),
    ("025860", "남해화학"), ("029530", "신도리코"), ("093370", "후성"),
    ("069960", "현대백화점"), ("111770", "영원무역"), ("002840", "미원상사"),
    ("009970", "영원무역홀딩스"), ("375500", "DL이앤씨"), ("210980", "SK디앤디"),
    ("023800", "인지컨트롤스"), ("006120", "SK디스커버리"), ("051600", "한전KPS"),
    ("044180", "KD"), ("005180", "빙그레"), ("002710", "TCC스틸"),
    ("005090", "SGC에너지"), ("000480", "조선내화"), ("007340", "DN오토모티브"),
    ("008350", "남선알미늄"), ("005680", "삼영전자"), ("336260", "두산퓨얼셀"),
    ("108670", "LX하우시스"), ("002350", "넥센타이어"), ("000850", "화천기공"),
    ("058470", "리노공업"), ("039570", "HDC랩스"), ("006650", "대한유화"),
    ("011690", "유양디앤유"), ("200130", "콜마비앤에이치"), ("115390", "록앤락"),
    ("003230", "삼양식품"), ("052670", "제일바이오"), ("014830", "유니드"),
    ("037560", "LG헬로비전"), ("004490", "세방전지"), ("023590", "다우기술"),
    ("026960", "동서"), ("034120", "SG세계물산"), ("189350", "서울바이오시스"),
    ("117580", "대성에너지"), ("049770", "동원F&B"), ("100090", "삼강엠앤티"),
    ("020000", "한섬"), ("001680", "대상"), ("007980", "태평양물산"),
    ("035510", "신세계인터내셔날"), ("014820", "동원시스템즈"), ("068400", "SK렌터카"),
    # 201-250: 중소형주 (상위)
    ("031430", "신세계푸드"), ("036580", "파미셀"), ("000210", "DL"),
    ("000670", "영풍"), ("030720", "동원산업"), ("014440", "영보화학"),
    ("039130", "하나투어"), ("092230", "KPX케미칼"), ("267980", "뿌리깊은"),
    ("100840", "SNT에너지"), ("003000", "부광약품"), ("016800", "퍼시스"),
    ("012510", "더존비즈온"), ("001430", "세아베스틸지주"), ("009310", "코오롱인더"),
    ("011930", "신성이엔지"), ("000320", "노루홀딩스"), ("009580", "무림P&P"),
    ("041650", "상신브레이크"), ("120110", "코오롱인더"), ("000830", "삼성물산"),
    ("214150", "클래시스"), ("263720", "디앤씨미디어"), ("214680", "디알텍"),
    ("047040", "대우건설"), ("091990", "셀트리온헬스케어"), ("001530", "DI동일"),
    ("185750", "종근당"), ("035900", "JYP Ent."), ("192080", "더블유게임즈"),
    ("043150", "바텍"), ("282690", "동아타이어"), ("060250", "NHN한국사이버결제"),
    ("002960", "한국쉘석유"), ("016590", "신대양제지"), ("011810", "STX"),
    ("038680", "에스넷"), ("136490", "선진"), ("011420", "갤럭시아에스엠"),
    ("083790", "크리스탈신소재"), ("138930", "BNK금융지주"), ("006840", "AK홀딩스"),
    ("000430", "대원강업"), ("009200", "무림페이퍼"), ("002030", "아세아"),
    ("005250", "녹십자홀딩스"), ("217270", "넵튠"), ("280360", "롯데웰푸드"),
    ("019170", "신풍제약"), ("066570", "LG전자"),
    # 251-300: 중소형주 (중위)
    ("241590", "화승엔터프라이즈"), ("079160", "CJ CGV"), ("071840", "롯데하이마트"),
    ("024890", "대원화성"), ("016710", "대성홀딩스"), ("085620", "미래에셋생명"),
    ("000520", "삼일제약"), ("082740", "HSD엔진"), ("008770", "호텔신라"),
    ("026940", "부국철강"), ("007860", "서연이화"), ("145020", "휴젤"),
    ("009460", "한창"), ("175330", "JB금융지주"), ("003650", "DRB동일"),
    ("066700", "테라젠이텍스"), ("018880", "한온시스템"), ("002310", "아세아제지"),
    ("000160", "삼양홀딩스"), ("003530", "한화투자증권"), ("012690", "모나리자"),
    ("000860", "강남제비스코"), ("214370", "케어젠"), ("033130", "하림지주"),
    ("002760", "보락"), ("032640", "LG유플러스"), ("051630", "진양화학"),
    ("027410", "BGF"), ("002900", "동양철관"), ("011150", "CJ씨푸드"),
    ("009770", "삼정펄프"), ("050960", "수산아이앤티"), ("000225", "삼성물산"),
    ("005610", "SPC삼립"), ("006570", "대림통상"), ("265520", "AP시스템"),
    ("006380", "카프로"), ("004980", "성신양회"), ("016740", "두올"),
    ("016610", "DB금융투자"), ("005440", "현대그린푸드"), ("002230", "피에스텍"),
    ("001230", "동국제강"), ("011500", "한농화성"), ("210540", "디와이파워"),
    ("023350", "한국종합기술"), ("004990", "롯데지주"), ("005720", "넥센"),
    ("011830", "반도건설"), ("014790", "한라"), ("002780", "진흥기업"),
    # 301-350: 소형주 (상위)
    ("033250", "체시스"), ("044450", "KSS해운"), ("001790", "대한제당"),
    ("004560", "현대비앤지스틸"), ("004090", "한국석유"), ("014790", "한라비스테온"),
    ("003300", "한일홀딩스"), ("002070", "남영비비안"), ("005320", "국도화학"),
    ("012800", "대창"), ("004890", "동일산업"), ("007690", "국도화학"),
    ("023150", "MDS테크"), ("003070", "코오롱글로벌"), ("002820", "SUN&L"),
    ("000140", "하이트론씨스템즈"), ("003080", "성보화학"), ("007630", "삼성물산"),
    ("007210", "벽산"), ("008730", "율촌화학"), ("005960", "동부건설"),
    ("036530", "SNT홀딩스"), ("024720", "한국콜마홀딩스"), ("037270", "YG PLUS"),
    ("002690", "동일제강"), ("001060", "JW중외제약"), ("014940", "오리엔탈정공"),
    ("025980", "아난티"), ("005620", "세방"), ("033920", "무학"),
    ("001940", "KISCO홀딩스"), ("027970", "세방전지"), ("037350", "성도이엔지"),
    ("009680", "삼보산업"), ("018670", "SK가스"), ("007280", "한국특수형강"),
    ("047400", "유니온머테리얼"), ("049800", "한국전자재료"), ("011320", "이화전기"),
    ("045970", "코아시아"), ("003610", "방림"), ("027580", "상보"),
    ("003570", "SNT다이나믹스"), ("950130", "카카오게임즈"), ("019180", "THQ홀딩스"),
    ("041920", "메디아나"), ("009440", "KC그린홀딩스"), ("214320", "이노션"),
    ("013710", "진에어"), ("215200", "메가스터디교육"),
    # 351-400: 소형주 (중위)
    ("004310", "현대약품"), ("020560", "아시아나항공"), ("004360", "세방전지"),
    ("002720", "국제약품"), ("008830", "대동기어"), ("015230", "대창단조"),
    ("016880", "웅진"), ("040910", "아이씨디"), ("011330", "유니켐"),
    ("025890", "한국주강"), ("003460", "유화증권"), ("014620", "성광벤드"),
    ("009070", "KCTC"), ("012750", "에스원"), ("011760", "현대코퍼레이션"),
    ("025820", "이구산업"), ("023960", "에쓰씨엔지니어링"), ("000995", "DB하이텍우"),
    ("078520", "에이블씨엔씨"), ("083930", "아바코"), ("060980", "한라홀딩스"),
    ("008110", "대동전자"), ("001550", "조비"), ("018500", "동원금속"),
    ("005850", "에스엘"), ("004430", "송원산업"), ("003480", "한진중공업홀딩스"),
    ("016090", "대명소노시즌"), ("014130", "한익스프레스"), ("036830", "솔브레인홀딩스"),
    ("002390", "한독"), ("200710", "에이디테크놀로지"), ("039310", "세림B&G"),
    ("003540", "대신증권"), ("097230", "한진중공업"), ("000370", "한화손해보험"),
    ("005500", "삼진제약"), ("039030", "이오테크닉스"), ("014990", "인디에프"),
    ("281820", "케이씨텍"), ("083650", "비에이치아이"), ("088290", "이원컴포텍"),
    ("011560", "세보엠이씨"), ("002390", "한독"), ("134380", "미원화학"),
    ("075970", "동국제약"), ("052020", "에스티"), ("089860", "롯데렌탈"),
    ("008250", "이건산업"), ("090460", "비에이치"),
]
...
def get_top_stocks(limit=400):
    ...
    # 방법 3: 모두 실패 시 백업 리스트 사용
    if df_total is None or df_total.empty:
        st.warning(f"⚠️ KRX API 실패: 백업 리스트({len(BACKUP_STOCK_LIST)}개)를 사용합니다.")
        return BACKUP_STOCK_LIST[:limit], None
